...
static DialogView *kDialogView = nil;
-(void)viewDidLoad {
...
- (void) categoryOK {
//    if (kDialogView) {
//        [delegate categoryName:kDialogView.textField.text];
//    }
    if (kDialogView) {
        NSString *cat = kDialogView.textField.text;
        
        //发送通知，传送category
        [[NSNotificationCenter defaultCenter] postNotificationName:@"CategoryTyped" object:self userInfo:[NSDictionary dictionaryWithObjectsAndKeys:cat, @"category", nil]];
    }
...
- (void) doneAction:(id)sender {
    ...
    kDialogView = dialogView;
    [dialogView.okButton addTarget:self action:@selector(categoryOK) forControlEvents:UIControlEventTouchUpInside];
    [self.view.superview addSubview:dialogView];
